...
if ($obj['accType'] == "Sender")
{
	...
	$sql = "
	INSERT INTO all_accounts (accountID, username, phoneNum, password, name, email, address, accType) VALUES ('$accountID', '$username', '$pnumber', '$password', '$name', '$email', '$address', '$accType');";
